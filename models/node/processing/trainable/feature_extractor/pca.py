...
class PCA(SKLearnFeatureExtractor):
    ...
    """
    _MODULE_NAME: Final[str] = 'node.processing.trainable.feature_extractor.pca'
    ...
    def _initialize_trainable_processor(self) -> (TransformerMixin, BaseEstimator):
        ...
        """
        return decomposition.PCA(n_components=self.number_of_components)
    ...
    def _format_raw_label(self, raw_label: FrameworkData) -> Any:
        ...
        :rtype: ndarray
        """
        formatted_label = np.asarray(raw_label.get_data_single_channel())
