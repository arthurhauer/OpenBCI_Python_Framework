...
from models.node.processing.segmentation.segmentation import Segmentation


class FixedWindowSegmentation(Segmentation):
    _MODULE_NAME: Final[str] = 'node.processing.segmentation.fixedwindowsegmentation'
